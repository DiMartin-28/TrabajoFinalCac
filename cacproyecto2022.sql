...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-07-2022 a las 22:45:45
...
CREATE TABLE `pedidos` (
  ...
  `codigopostal` varchar(9) COLLATE utf8_spanish_ci NOT NULL,
...
(1, 'prueba@gmail.com', '909090', 'Mircea Eliade'),
(2, 'fulano@gmail.com', '919191', 'Cosme Fulanito');
...
--
ALTER TABLE `localidades`
  ADD CONSTRAINT `localidades_ibfk_1` FOREIGN KEY (`idprovincialocalidad`) REFERENCES `provincias` (`idprovincia`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
